...
#>  $ created_at : chr "2026-06-26T22:14:17Z"
#>  $ n_snapshots: int 3
#>  $ snapshots  :List of 3
#>   ..$ raw          :List of 26
#>   ..$ complete_only:List of 26
#>   ..$ high_value   :List of 26
#>  $ events     : NULL
#>  $ keys       : NULL
...
#> 1     1           raw    tap 2026-06-26 22:14:17   20    4         0
#> 2     2 complete_only filter 2026-06-26 22:14:17   12    4         0
#> 3     3    high_value filter 2026-06-26 22:14:17    4    4         0
...
#>       pipeline controls snapshot_id object_id object_name version step_id event
#> 1       orders                                                                 
#> 2 orders, ....                                                                 
#> 3 orders, ....                                                                 
#>   source srcref parent_snapshot_ids level evidence
#> 1                                                 
#> 2                                                 
#> 3
```
